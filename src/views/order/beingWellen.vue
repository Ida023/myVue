        ...
        <el-table :data="tableData" border tooltip-effect="dark" style="width: 100%"   @selection-change="selsChange">
          ...
          <el-table-column label="操作"  prop="label" align="center"  width="160px">
            <template scope="scope">
              ...
              <el-tooltip content="检测打印"  effect="dark" placement="bottom">
                <i  class="iconfontyyy" content="Bottom center" @click="rowBtnDone(scope.row, '检测打印')">&#xe610;</i>
              </el-tooltip>
            </template>
          </el-table-column>
        </el-table>
...
/*        this.$http.get('static/Table2.json').then(res=>{
      ...
      filterData(){
        ...
        this.pageFilter.shopOrderId = data.shopOrderId;   //  平台订单号？
