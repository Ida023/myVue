  ...
  <div id="outermost_wrap" class="user_manager_wrap">
    ...
    <div id="content_wrap" class="content_wrap">
      ...
      <el-row class="supplier_btn last_btn">
        <el-button type="primary" size="small" @click="batchBtnDone('发邮件');"  v-if="pageFilter.channelId == '01' && pageFilter.channelId != ''">发邮件</el-button>
       ...
       <!-- <el-button type="primary" size="small" @click="batchBtnDone('批量提单');">批量提单</el-button>-->
        <el-button type="primary" size="small" @click="batchBtnDone('批量作废');">批量作废</el-button>
      </el-row>
      <div id="item_list">
...
<!--              <el-tooltip content="提单"  effect="dark" placement="bottom">
                <i  class="iconfontyyy" content="Bottom center" @click="rowBtnDone(scope.row, '提单')">&#xe63d;</i>
              </el-tooltip>-->
              <el-tooltip content="检测库存"  effect="dark" placement="bottom">
                <i  class="iconfontyyy" content="Bottom center" @click="rowBtnDone(scope.row, '检测库存')">&#xe610;</i>
              </el-tooltip>
              <el-tooltip content="作废"  effect="dark" placement="bottom">
                <i  class="iconfontyyy" content="Bottom center" @click="rowBtnDone(scope.row, '作废')">&#xe6f7;</i>
              </el-tooltip>
            </template>
          </el-table-column>
        </el-table>
    ...
    methods: {
      ...
      batchBtnDone:function(type){    // 批量操作
        ...
        this.sels.forEach(function(item){
          var cancel =  type == '批量提单' ? 0 : 1;
          params.push({nodeId:item.nodeId,orderId:item.orderId,cancel:cancel});
        })
        switch(type){
          case '发邮件':
            commonMail('发邮件');
          ...
          case '发消息':
            ...
            break;
          case '批量提单':
            vm.sels.length<1 ? vm.tips():vm.doItem('您确定提单该订单？','orderInfo/completeMultiTask',params,vm.getData);
            break;
          case '批量作废':
            vm.sels.length<1 ? vm.tips():vm.doItem('您确定作废该订单？','orderInfo/completeMultiTask',params,vm.getData);
            break;
        }
      },
