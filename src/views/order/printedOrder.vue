<template>
  ...
  <div id="outermost_wrap" class="user_manager_wrap">
        ...
        <el-table :data="tableData" border tooltip-effect="dark" style="width: 100%"   @selection-change="selsChange">
          ...
          <el-table-column label="操作"  prop="label" align="center"  width="160px">
            <template scope="scope">
              ...
              <el-tooltip content="检测发货"  effect="dark" placement="bottom">
                <i  class="iconfontyyy" content="Bottom center" @click="rowBtnDone(scope.row, '检测发货')">&#xe610;</i>
              </el-tooltip>
            </template>
          </el-table-column>
        </el-table>
    ...
    <!------------------拦截订单 弹出框--------------------------->
    <intercept-dialog :id-value="interceptData.id" :is-open="interceptData.isOpen" :account-id="pageFilter.accountNo" @getData="getData"></intercept-dialog>
    <!------------------发起预退件 弹出框--------------------------->
