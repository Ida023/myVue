    ...
    <div id="content_wrap" class="content_wrap">
      <el-row >
        ...
        <div style="text-align: right;">
          <el-button type="primary" class="research_btn" size="small"  @click="goToExceptionShipped">签收异常</el-button>
        </div>
      </el-row>
      <!--筛选条件 平台，账号，站点及国家-->
      ...
      <el-row class="supplier_btn ">
        ...
        <el-button type="primary" size="small"  @click="exportData">导出跟踪单</el-button>
      </el-row>
      <el-row class="supplier_btn last_btn" v-if="pageFilter.channelId != ''">
        ...
        <el-table :data="tableData" border tooltip-effect="dark" style="width: 100%"   @selection-change="selsChange">
          ...
          <el-table-column label="操作"  prop="label" align="center"  width="160px">
            <template scope="scope">
              ...
              <el-tooltip content="新增配件申请"  effect="dark" placement="bottom" v-if="scope.row.allowAccessory == 1">
              ...
              <el-tooltip content="计算利润"  effect="dark" placement="bottom">
                <i  class="iconfontyyy" content="Bottom center" @click="rowBtnDone(scope.row, '计算利润')">&#xe610;</i>
              </el-tooltip>
            </template>
          </el-table-column>
        </el-table>
...
/*        this.$http.get('static/Table2.json').then(res=>{
      ...
      goToExceptionShipped:function(){
          this.$router.push({
            path:'/exceptionShipped',
          })
      }
    }
  }
