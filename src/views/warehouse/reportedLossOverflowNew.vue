  ...
  <div id="outermost_wrap" class="role" style="">
    ...
    <div id="content_wrap" class="content_wrap">
        ...
        <el-collapse v-model="activeNames">
          <el-collapse-item name="1">
            <div class=" flex">
              ...
              <el-radio-group v-model="pageFilter.whId" size="small" @change="getReportList" class="flex1">
            ...
            <div class=" flex">
              ...
              <el-radio-group v-model="pageFilter.aaaa" size="small" @change="getReportList">
                <el-radio-button  label="01" class="marginBottom" v-if="ButtonInfo['报损报溢']!='0'">报损报溢</el-radio-button>
                <el-radio-button  label="02"  class="marginBottom" v-if="ButtonInfo['盘盈盘亏']!='0'">盘盈盘亏</el-radio-button>
              </el-radio-group>
            </div>
            <div class=" flex">
      ...
      <el-row class="supplier_btn">
        <el-button type="primary" size="small"  v-if="pageFilter.aaaa == '01'" @click="dialogFlag.addDia = true;">新增报溢报损</el-button>
      </el-row>
      ...
      <el-table :data="reportListData" id="item_list" border tooltip-effect="dark" style="width: 100%" @selection-change="selsChange">
        ...
        <el-table-column sortable align="center" prop="refValue" label="盘点单" ></el-table-column>
        ...
        <el-table-column sortable align="center" prop="appUser" label="审核意见"></el-table-column>
      </el-table>
    </div>
