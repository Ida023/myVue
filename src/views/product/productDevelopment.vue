  ...
  <div id="outermost_wrap" class="user_manager_wrap">
    ...
    <div id="content_wrap" class="content_wrap">
        ...
        <el-collapse v-model="activeNames">
          <el-collapse-item name="1">
            ...
            <el-radio-group v-model="defaultData.states" @change="getPictureList()"  size="small">
              ...
              <el-radio-button  label="草稿" v-if="ButtonInfo['草稿'] !='0'">草稿</el-radio-button>
              <el-radio-button  label="待审核" v-if="ButtonInfo['待审核'] !='0'">待审核</el-radio-button>
              <el-radio-button  label="审核不通过" v-if="ButtonInfo['审核不通过'] !='0'">审核不通过</el-radio-button>
      ...
      <el-row class="supplier_btn">
        ...
        <el-button type="primary" size="small" @click="importData.isOpen = !importData.isOpen"  v-if="ButtonInfo.批量导入草稿!='0'">批量导入草稿</el-button>
      ...
      <el-row class="supplier_btn last_btn">
        <el-button type="primary" size="small" @click="batchInfoDialog3" v-if="defaultData.states==='草稿' && ButtonInfo['批量提交']!='0'">批量提交</el-button>
        <el-button type="primary" size="small" @click="batchInfoDialog4" v-if="defaultData.states==='草稿' && ButtonInfo['批量删除']!='0'">批量删除</el-button>
        <el-button type="primary" size="small" @click="batchInfoDialog5" v-if="defaultData.states==='待审核' && ButtonInfo['批量同意']!='0'">批量同意</el-button>
        <el-button type="primary" size="small" @click="batchInfoDialog6" v-if="defaultData.states==='待审核' && ButtonInfo['批量不同意']!='0'">批量不同意</el-button>
        ...
        <el-table :data="GetListData" border tooltip-effect="dark" style="width: 100%"   @selection-change="selsChange">
          ...
          <el-table-column width="150" id="space" label="操作" align="center" >
            <template scope="scope">
              <el-tooltip content="查看"  effect="dark" placement="bottom" v-if="scope.row.state==='草稿' && ButtonInfo['查看']!='0'">
              ...
              <el-tooltip content="查看"  effect="dark" placement="bottom" v-if="scope.row.state==='待审核' && ButtonInfo['查看']!='0'">
              ...
              <el-tooltip content="查看"  effect="dark" placement="bottom" v-if="scope.row.state==='审核不通过' && ButtonInfo['查看']!='0'">
              ...
              <el-tooltip content="查看"  effect="dark" placement="bottom" v-if="scope.row.state==='待提交商品' && ButtonInfo['查看']!='0'">
                <i  class="iconfontyyy" @click="dialogFlag.prlblemask=true; SonDis= false;  describeDis= true; isShow=false; dialogFlag.dialogTitle='查看产品详情'; getCreateIssues(scope.row);
                describ(scope.row,dialogFlag.inputDisabled = true); dialogFlag.isOpen = true;" content="Bottom center">&#xe600;</i>
              </el-tooltip>
              <el-tooltip content="编辑"  effect="dark" placement="bottom" v-if="scope.row.state==='草稿' && ButtonInfo['编辑']!='0'">
              ...
              <el-tooltip class="item" effect="dark" content="提交" placement="top-start" v-if="scope.row.state==='草稿' && ButtonInfo['提交']!='0'">
                <i class="iconfontyyy" @click="productSubmit(scope.row)">&#xe63e;</i>
              </el-tooltip>
              <el-tooltip class="item" effect="dark" content="删除" placement="top-start" v-if="scope.row.state==='草稿' && ButtonInfo['删除']!='0'">
                <i class="iconfontyyy" @click="productDelete(scope.row)">&#xe6f7;</i>
              </el-tooltip>
              <el-tooltip class="item" effect="dark" content="不同意" placement="top-start" v-if="scope.row.state==='待审核' && ButtonInfo['不同意']!='0'">
                <i class="iconfontyyy" @click="batchInfoDialog2(scope.row)">&#xe665;</i>
              </el-tooltip>
              <el-tooltip class="item" effect="dark" content="同意" placement="top-start" v-if="scope.row.state==='待审核' && ButtonInfo['同意']!='0'">
    ...
    <el-dialog :title="dialogFlag.dialogTitle" :visible.sync="dialogFlag.isOpen" :close-on-click-modal="false" @close="addDill">
      <el-tabs v-model="dialogFlag.activeTab"  @tab-click="clicktab">
        ...
        <el-tab-pane label="采购信息"   name="2">
          ...
          <!--<purchase-dialog  :purchaseparentinfo-detail="dialogFlag.activeTab" :input-disabled="dialogFlag.inputDisabled" ></purchase-dialog>-->
        </el-tab-pane>
        ...
        <el-tab-pane label="产品问题"   name="6" >
          ...
          <!--<problem-dialog  :problemparentinfo-detail="dialogFlag.activeTab" :input-disabled="dialogFlag.inputDisabled" @parentmsgg="parentProblem"></problem-dialog>-->
        </el-tab-pane>
      </el-tabs>
      <div slot="footer" class="dialog-footer">
...
//        alert('img2')
      ...
      productDelete:function(row,val){//草稿删除
        let vm = this;
      ...
      productSubmit:function(row,val){//草稿提交
        let vm = this;
        vm.auditFrom2.productIds=[];
        vm.auditFrom2.productIds.push(row.productId)
        let msg;
      ...
      add(){
        this.$refs.SpecialAttributes.addCheckedData(vm.SonAttribute);
      },
