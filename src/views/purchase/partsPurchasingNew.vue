        ...
        <div id="content_wrap">
          <el-row class="marginBottom"  :gutter="10">
            <el-col :span="6" class="optionValue">
              <el-input v-model="pagefilters.skuNo" size="small" placeholder="请输入配件申请单编号"></el-input>
            </el-col>
            <el-col :span="1">
            ...
            <el-collapse v-model="activeNames">
              <el-collapse-item name="1">
                ...
                <el-radio-group v-model="pagefilters.poStatus" size="small"   @change="pagefilters.skuNo ='';getPartsList();" >
                  <el-radio-button label="01"   v-if="ButtonInfo['待采购处理']!='0'">待采购处理</el-radio-button>
                  <el-radio-button label="02"   v-if="ButtonInfo['等待退件中']!='0'">等待退件中</el-radio-button>
                  <el-radio-button label="03"   v-if="ButtonInfo['仓库处理中']!='0'">仓库处理中</el-radio-button>
                  <el-radio-button label="04"   v-if="ButtonInfo['待采购配件']!='0'">待采购配件</el-radio-button>
                  <el-radio-button label="05"   v-if="ButtonInfo['已采购配件']!='0'">已采购配件</el-radio-button>
                  <el-radio-button label="06"   v-if="ButtonInfo['已调拨']!='0'">已调拨</el-radio-button>
                  <el-radio-button label="07"   v-if="ButtonInfo['已完成']!='0'">已完成</el-radio-button>
                </el-radio-group>
              </el-collapse-item>
            </el-collapse>
          </el-row>
      ...
      <div class="smallDia">
        <el-dialog title="筛选" :visible.sync="dialogFlag.sccrenisOpen" size="small" :close-on-click-modal="false" @open="colseScreen();">
          <div class="data_body">
            ...
            <text-input   condition-name="配件申请单编号"   @child-change-val="getChildren" :selectValue="skuNoo" text-type="skuNo"   ></text-input >
            <text-input   condition-name="关联销售订单"   @child-change-val="getChildren" :selectValue="skuNoo" text-type="skuNo"   ></text-input >
            <el-row class="row">
              <el-col class="col" :span="4">申请人</el-col><el-col class="col" :span="4">是</el-col>
            ...
            <el-row class="row">
              <el-col class="col" :span="4">是否需退件</el-col><el-col class="col" :span="4">是</el-col>
              <el-col class="col_input" :span="16">
            ...
            <el-row class="row">
              <el-col class="col" :span="4">发配件仓库</el-col><el-col class="col" :span="4">是</el-col>
              <el-col class="col_input" :span="16">
                <el-select size="small" v-model="pagefilters.poStatus" filterable clearable>
                  <el-option v-for="item in selectOptions" :key="item.value" :label="item.label" :value="item.value"></el-option>
                </el-select>
