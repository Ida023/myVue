          ...
          <div class="table_data">
            <div id="item_list">
              <el-table border tooltip-effect="dark" :data="categoryListData"   @selection-change="selsChange" ref="tableData">
                ...
                <el-table-column label="商品名称"  prop="proName" align="center"  sortable ></el-table-column>
                <el-table-column sortable align="center" prop="whName" label="所属仓库" ></el-table-column>
                <el-table-column label="在存库存"   prop="oldInvQty" align="center"  sortable ></el-table-column>
                <el-table-column label="故障品库存"   prop="deviationQty" align="center"  sortable ></el-table-column>
              </el-table>
            </div>
          </div>
    ...
    export default{
        data(){
            return {
              ...
              options: [{value: 'SKU', label: 'SKU'}, {value: '产品名称', label: '产品名称'}],
              sels:[],
            }
        },
        props:['defaltKey'],
        computed:{
          getPlaceholder:function(){
            return this.selectParams.optionTitle == 'SKU' ? '多个SKU请用逗号,分隔开' : this.selectParams.optionTitle == '产品名称' ? '请输入产品名称':'';
          },
      },
        mounted () {
        ...
        methods: {
          ...
          getResponseData:function(data) {
            ...
            this.httpPost('warehouseadjustment/selectProAdjList', this.pageFilter).then(res => {
